...
const About = () => {
  ...
  return (
    <div className='lg:flex dark:bg-bluish dark:text-light'>
        <div className='px-4 sm:px-8 md:px-12 lg:px-20 flex flex-col gap-24 md:gap-32 lg:gap-48 lg:w-2/3 xl:1/2'>
            ...
            <div className='flex flex-col gap-12 justify-center' ref={skillRef}>
                ...
                <motion.div initial={{x:'-300px'}} animate={isSkillRefInView ? {x:0} : {}} className='flex gap-4 flex-wrap'>
                    <div className='rounded p-2 text-sm cursor-pointer dark:bg-light dark:text-darkish dark:hover:bg-darkish dark:hover:text-light bg-black text-white hover:bg-white hover:text-black'>
                        Javascript
                    </div>
                    <div className='rounded p-2 text-sm cursor-pointer dark:bg-light dark:text-darkish dark:hover:bg-darkish dark:hover:text-light bg-black text-white hover:bg-white hover:text-black'>
                        Typescript
